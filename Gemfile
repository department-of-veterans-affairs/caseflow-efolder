...
gem "request_store"
gem "rubyzip", ">= 1.3.0"
gem "ruby_claim_evidence_api", git: "https://github.com/department-of-veterans-affairs/ruby_claim_evidence_api.git", branch: "prototype/aws-gemspec-updates"
gem "sass-rails", "~> 5.0"
gem "sentry-raven"
