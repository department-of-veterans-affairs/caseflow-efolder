  ...
  context "when job is queued" do
    scenario "the job runs", download: true do
      perform_enqueued_jobs do
        ...
        expect(DownloadHelpers.download_filenames).to eq(["touched-file.txt"])
        ...
        expect(DownloadHelpers.download_filenames).to contain_exactly("touched-file.txt", "touched-file-download.txt")
      end
    end
  end
end
